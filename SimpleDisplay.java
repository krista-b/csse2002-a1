...
public class SimpleDisplay {
    ...
    private static Building createBuilding() {
        ...
        Room room1 = new Room(101, RoomType.STUDY, 10);
        ...
        try {
            room2.addSensor​(new OccupancySensor(new int[]{32, 31, 28}, 4, 30));
            room4.addSensor​(new CarbonDioxideSensor(new int[]{690, 740}, 5, 700, 150));
        ...
        try {
            room1.addSensor​(new NoiseSensor(new int[]{35, 38}, 3));
        } catch (DuplicateSensorException e) {
            e.printStackTrace();
        }
        ...
        try {
            room2.addSensor​(new TemperatureSensor(new int[]{25, 26, 24}));
            room3.addSensor​(new TemperatureSensor(new int[]{24, 21}));
        } catch (DuplicateSensorException e) {
            e.printStackTrace();
        }
        ...
        try {
            room1.addSensor​(new TemperatureSensor(new int[]{25, 34, 61, 85}));
            room1.addSensor​(new OccupancySensor(new int[]{15, 12, 2, 0}, 1, 20));
            room1.addSensor​(new CarbonDioxideSensor(new int[]{0, 100}, 5,
                    700, 150));
        } catch (DuplicateSensorException e) {
            e.printStackTrace();
        }
